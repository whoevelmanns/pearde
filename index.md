...
| `@@jira` | mirroring a PRD's state onto its Jira issue, and reading drift/new tickets back | @references/skills/pearde-jira.md · @resources/jira/README.md · @resources/jira/jira_sync.py |
...
| `@@skills` | the entry points, what each is a door to, and how one is named | @SKILL.md · @references/skills/pearde.md · @references/skills/pearde-drill.md · @references/skills/pearde-memo.md · @references/skills/pearde-view.md · @references/skills/pearde-report.md · @references/skills/pearde-master.md · @references/skills/pearde-doctor.md · @references/skills/pearde-persona.md · @references/skills/pearde-persona-ask.md · @references/skills/pearde-persona-create.md · @references/skills/pearde-scout.md · @references/skills/pearde-workflow.md · @references/skills/pearde-graph.md · @references/skills/pearde-knowledge.md · @references/skills/pearde-jira.md · @references/install.md |
...
| `@@graph` | knowledge-graph rounds — graphify, the ollama backend, the vault | @references/skills/pearde-graph.md · @references/graph.md · @resources/graph/graph.sh |
